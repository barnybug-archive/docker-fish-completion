...
complete -c docker -A -f -n '__fish_seen_subcommand_from build' -l cpu-shares -d 'CPU shares (relative weight)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from build' -l shm-size -d 'Size of /dev/shm, default value is 64MB'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l ip -d 'Container IPv4 address (e.g. 172.30.100.104)'
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l ip6 -d 'Container IPv6 address (e.g. 2001:db8::33)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l net -d 'Connect a container to a network'
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l net-alias -d 'Add network-scoped alias for the container'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l shm-size -d 'Size of /dev/shm, default value is 64MB'
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l stop-signal -d 'Signal to stop a container, SIGTERM by default'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from ps' -s l -l latest -d 'Show the latest created container (includes all states)'
complete -c docker -A -f -n '__fish_seen_subcommand_from ps' -s n -d 'Show n last created containers (includes all states)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l blkio-weight-device -d 'Block IO weight (relative device weight)'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l cpu-shares -d 'CPU shares (relative weight)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l detach-keys -d 'Override the key sequence for detaching a container'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l device -d 'Add a host device to the container'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l device-read-bps -d 'Limit read rate (bytes per second) from a device'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l device-read-iops -d 'Limit read rate (IO per second) from a device'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l device-write-bps -d 'Limit write rate (bytes per second) to a device'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l device-write-iops -d 'Limit write rate (IO per second) to a device'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l dns-opt -d 'Set DNS options'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l ip -d 'Container IPv4 address (e.g. 172.30.100.104)'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l ip6 -d 'Container IPv6 address (e.g. 2001:db8::33)'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l ipc -d 'IPC namespace to use'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l isolation -d 'Container isolation technology'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l kernel-memory -d 'Kernel memory limit'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l memory-reservation -d 'Memory soft limit'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l memory-swap -d "Swap limit equal to memory plus swap: '-1' to enable unlimited swap"
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l memory-swappiness -d 'Tune container memory swappiness (0 to 100)'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l name -d 'Assign a name to the container'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l net -d 'Connect a container to a network'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l net-alias -d 'Add network-scoped alias for the container'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l oom-kill-disable -d 'Disable OOM Killer'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l oom-score-adj -d "Tune host's OOM preferences (-1000 to 1000)"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l pids-limit -d 'Tune container pids limit (set -1 for unlimited)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l shm-size -d 'Size of /dev/shm, default value is 64MB'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l sig-proxy -d 'Proxy received signals to the process'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l stop-signal -d 'Signal to stop a container, SIGTERM by default'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -s t -l tty -d 'Allocate a pseudo-TTY'
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l tmpfs -d 'Mount a tmpfs directory'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l userns -d 'User namespace to use'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from start' -l detach-keys -d 'Override the key sequence for detaching a container'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from stats' -s a -l all -d 'Show all containers (default shows just running)'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l blkio-weight -d 'Block IO (relative weight), between 10 and 1000'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l cpu-shares -d 'CPU shares (relative weight)'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l cpu-period -d 'Limit CPU CFS (Completely Fair Scheduler) period'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l cpu-quota -d 'Limit CPU CFS (Completely Fair Scheduler) quota'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l cpuset-cpus -d 'CPUs in which to allow execution (0-3, 0,1)'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l cpuset-mems -d 'MEMs in which to allow execution (0-3, 0,1)'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l help -d 'Print usage'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l kernel-memory -d 'Kernel memory limit'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -s m -l memory -d 'Memory limit'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l memory-reservation -d 'Memory soft limit'
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l memory-swap -d "Swap limit equal to memory plus swap: '-1' to enable unlimited swap"
complete -c docker -A -f -n '__fish_seen_subcommand_from update' -l restart -d 'Restart policy to apply when a container exits'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from volume' -l help -d 'Print usage'
